...
- `ResendService`: An object that contains the configuration and functions necessary to send emails through Resend (default service).
  - `sendMail`: A function that takes email parameters and sends it through Resend.
...
- Sending emails through Resend (default service).
