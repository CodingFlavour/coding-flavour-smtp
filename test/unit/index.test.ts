...
describe("Coding Flavour SMTP Test Suite", () => {
  it("should return the correct object when invoking library", async () => {
    ...
    expect(CodingFlavourSMTP).toHaveProperty("sendMail");
    ...
    expect(CodingFlavourSMTP.sendMail).toBeDefined();
    ...
    expect(CodingFlavourSMTP.sendMail).toBeInstanceOf(Function);
  })
})